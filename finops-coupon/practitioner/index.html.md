...
*List price read from the FinOps Foundation's own catalog in August 2026. They set the prices and can revise them, so check [the product page](https://learn.finops.org/path/finops-certified-practitioner-self-paced) for the current number before you buy.*
